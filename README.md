...
Note: Replace all `sharegpt.com` domains in this project with your own domain, rename `.env.example` to `.env`, and modify the parameters inside to match your own configuration. That's all you need to do.
